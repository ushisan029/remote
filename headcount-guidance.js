(()=>{
  ...
  const RULES=[
    ...
    {test:/衛生管理者/,note:'【正しい人数】衛生管理者：全業種で常時50人以上。選任数は50～200人=1人以上、201～500人=2人以上、501～1,000人=3人以上、1,001～2,000人=4人以上、2,001～3,000人=5人以上、3,001人以上=6人以上。',ref:MGMT_REF},
    {test:/衛生管理者/,extra:/専任|有害業務|衛生工学衛生管理者/,note:'【正しい人数】専任の衛生管理者：常時1,000人を超える事業場、または常時500人を超え、法定の有害業務に常時30人以上を従事させる事業場では、少なくとも1人を専任とする。',ref:MGMT_REF},
    ...
    {test:/衛生委員会/,note:'【正しい人数】衛生委員会：全業種で常時50人以上の事業場に設置。',ref:MGMT_REF},
  ...
  function annotate(q){
    ...
    for(const rule of RULES){if(rule.test.test(text)&&(!rule.extra||rule.extra.test(text))){addOnce(points,rule.note);addRef(q,rule.ref);touched=true}}
